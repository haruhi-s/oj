...
evalSKI K = const
evalSKI I = id
evalSKI (Ap x y) = evalSKI x $ evalSKI y
...
prettyPrintSKI K = "K"
prettyPrintSKI I = "I"
prettyPrintSKI (Ap x y)="("++prettyPrintSKI x++" "++prettyPrintSKI y++")"
...
rev :: SKI (a -> (a -> b) -> b)
rev = Ap (Ap S (Ap K (Ap S I))) ((Ap (Ap S (Ap K K)) I))

comp :: SKI ((b -> c) -> (a -> b) -> (a -> c))
comp = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) I))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap K I))))) (Ap (Ap S (Ap K K)) (Ap K I)))

flip' :: SKI ((a -> b -> c) -> (b -> a -> c))
flip' = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) I))))) (Ap (Ap S (Ap K K)) (Ap K I)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap K I))

rotr :: SKI (a -> (c -> a -> b) -> c -> b)
rotr = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap K I))))) (Ap (Ap S (Ap K K)) (Ap K I)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) I))

rotv :: SKI (a -> b -> (a -> b -> c) -> c)
rotv = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap K K)) (Ap K I))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) I)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap K I))
...
join :: SKI ((a -> a -> b) -> a -> b)
join = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) I))) (Ap K I)))) (Ap K I)
...
true :: SKI (Bool' a)
true = Ap (Ap S (Ap K K)) I

false :: SKI (Bool' a)
false = Ap K I

not' :: SKI (Bool' a -> Bool' a)
not' = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) I))))) (Ap (Ap S (Ap K K)) (Ap K I)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap K I))

and' :: SKI (Bool' (Bool' a) -> Bool' a -> Bool' a)
and' = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) I))) (Ap K I)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K I)))

or' :: SKI (Bool' (Bool' a) -> Bool' a -> Bool' a)
or' = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) I))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K K)))))) (Ap (Ap S (Ap K K)) (Ap K I)))))) (Ap K I)

xor' :: SKI (Bool' (Bool' a -> Bool' a) -> Bool' a -> Bool' a)
xor' = Ap (Ap S (Ap (Ap S I) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K S)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K S)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K K)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap K I))))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K I)))))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K K)))))) (Ap (Ap S (Ap K K)) (Ap K I)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K S)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K S)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K K)))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap K I))))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K S)))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K K)))))) (Ap (Ap S (Ap K K)) (Ap K I)))))))) (Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap K K)))) (Ap (Ap S (Ap K K)) (Ap K I))))
